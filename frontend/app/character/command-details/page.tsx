...
export default function CharacterCommandDetailsPage() {
  ...
  <div className="mt-3 pl-6">
    ...
    <ol className="list-decimal columns-1 gap-x-12 space-y-2 pl-6 sm:columns-2">
      <li className="break-inside-avoid">常時</li>
      <li className="break-inside-avoid">セットアップ</li>
      <li className="break-inside-avoid">イニシアチブ</li>
      <li className="break-inside-avoid">ムーブ</li>
      <li className="break-inside-avoid">マイナー</li>
      <li className="break-inside-avoid">メジャー</li>
      <li className="break-inside-avoid">行動</li>
      <li className="break-inside-avoid">インスタント</li>
      <li className="break-inside-avoid">ダメージロール</li>
      <li className="break-inside-avoid">判定直前</li>
      <li className="break-inside-avoid">判定直後</li>
      <li className="break-inside-avoid">クリンナップ</li>
      <li className="break-inside-avoid">プリプレイ</li>
      <li className="break-inside-avoid">ブリーフィング</li>
      <li className="break-inside-avoid">本文</li>
      <li className="break-inside-avoid">基本動作</li>
    </ol>
  </div>
</details>
