...
const steps: Step[] = [
  ...
  {
    number: "7",
    title: "出力オプションとレビューを確認する",
    text: (
      <>
        必要に応じて [チャットパレット出力オプション] を開き、出力したい項目を調整する。
        出力オプションは初期状態では閉じているため、必要な場合だけ開いて設定する。
        一括操作の [すべてON] / [すべてOFF] や、各項目のチェックボックスで出力内容を調整できる。
        右側のチャットパレットのレビューは、[レビューを更新] をクリックすると確認できる。
      </>
    ),
    images: [],
  },
      ...
      <section>
        <div className="mb-10 space-y-4">
          <p className="text-sm leading-8 text-neutral-800">
            ...
            出力オプションを利用すると、チャットパレットに含める項目を調整できます。
          </p>
        </div>
